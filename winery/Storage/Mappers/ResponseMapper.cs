...
namespace Storage
{
	...
	{
		public static IQueryable<Establishment> SearchWineries(this IQueryable<Establishment> lstWineries, string token)
		{
		...
		public static IQueryable<Establishment> FilterWineries(this IQueryable<Establishment> lstWineries, Filter[] filters)
		{
		...
		public static IQueryable<Establishment> SortWineries(this IQueryable<Establishment> lstWineries, Sort sort)
		{
		...
		public static IQueryable<Wine> SearchWines(this IQueryable<Wine> lstWines, string token)
		{
			...
			{
				token = token.ToLower();
				var colorTokens = Helper.ToEnumArray<WineColor>()
