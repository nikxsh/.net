...
namespace Storage.Datastore
{
	public class WineryDataStore : IWineryDataStore, IDisposable
	{
		...
		public Task<IQueryable<Establishment>> GetAllWineriesAsync()
		{
		...
		public Task<Establishment> GetWineryByIdAsync(Guid id)
		{
		...
		public Task<Guid> AddWineryAsync(Establishment winery)
		{
		...
		public Task<int> UpdateWineryAsync(Establishment winery)
		{
